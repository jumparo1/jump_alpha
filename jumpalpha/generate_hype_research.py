...
hype_data = {
    'symbol': 'HYPE',
    'quick_overview': '''Moat 🛡️: Decentralized perpetual futures exchange with high performance and low fees. Built on Arbitrum, offering up to 50x leverage and deep liquidity.
...
VC / Whales 🐳: Backed by top crypto VCs | Early institutional interest | Strategic partnerships forming''',
    ...
    'futures_stats': '''Futures 📊: OI: $85M (+5.2% 24h) | Funding: 0.008% | Long/Short: 1.12
...
if __name__ == "__main__":
    output_path = create_quick_research(hype_data)
    print(f"HYPE quick research generated and saved to: {output_path}") 